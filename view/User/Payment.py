...
class Payment(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Dispatch fee
        price_label_2 = tk.Label(frame1, text=self.dispatch_fee_str, font=("Inter", 20), fg="black", bg="white")
        ...
        # Total fee
        price_label_3 = tk.Label(frame1, text=self.total_fee_str, font=("Inter", 26, "bold"), fg="black", bg="white")
        price_label_3.place(x=714, y=334)
        # Time fee
        price_label_4 = tk.Label(frame1, text=self.duration_fee_str, font=("Inter", 20), fg="black", bg="white")
