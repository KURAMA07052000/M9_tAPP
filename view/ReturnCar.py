...
class ReturnCar(tk.Frame):
    def __init__(self, parent, controller):
        ...
        date=Label(text="Drop-off Time:", fg="black", bg="white", font=("Microsft YaHei UI Light",12))
        date.place(x=550, y=120)
       
        self.pickupd = Entry( width=25, fg="black", border=2, bg="white", font=("Microsft YaHei UI Light",11))
