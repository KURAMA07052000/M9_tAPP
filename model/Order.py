    ...
    def get_charge(self):
        ...
        if self.charge == 0.0:
            ...
            if(self.end_time == None):
                return 0.0
            self.duration_hour = (self.end_time - self.start_time).total_seconds()
            # print(self.duration_hour)
            # find vehicle type
            self.cur.execute("""SELECT vehicle_type FROM Vehicle WHERE vehicle_id = ?""", [self.vehicle_id])
            ...
            print("order charge: " + str(self.total_fee))
